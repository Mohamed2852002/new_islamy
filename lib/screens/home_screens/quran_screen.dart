...
class QuranScreen extends StatelessWidget {
  ...
  final List<String> surahNamesArabic = const [
    "الفاتحة",
    "البقرة",
    "آل عمران",
    "النساء",
  ...
  final List<String> surahNamesEnglish = const [
    "Al-Fatiha",
    "Al-Baqarah",
    "Aal-E-Imran",
    "An-Nisa",
  ...
  final List<int> surahVerses = const [
    7,
    286,
    200,
    176,
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                return QuranListWidget(
                  suraModel: SuraModel(
                      arabSuraName: surahNamesArabic[index],
                      surahNumber: index + 1,
                      englishSuraName: surahNamesEnglish[index],
                      suraVerses: surahVerses[index]),
                );
              },
            ),
          ),
